...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materias_primas_empaque', to='core.unidadesdemedida'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='productoselaborados',
            constraint=models.CheckConstraint(condition=models.Q(models.Q(('es_intermediario', True), ('punto_reorden__isnull', False)), models.Q(('es_intermediario', False), ('punto_reorden__isnull', True)), _connector='OR'), name='intermediario_punto_reorden'),
        ),
    ]

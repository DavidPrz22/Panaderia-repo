...
class Recetas(models.Model):
    producto_elaborado = models.ForeignKey(ProductosElaborados, on_delete=models.CASCADE, related_name='recetas_como_producto_final')
    componente_materia_prima = models.ForeignKey(MateriasPrimas, on_delete=models.CASCADE)
    componente_producto_intermedio = models.ForeignKey(ProductosElaborados, on_delete=models.CASCADE, related_name='recetas_como_componente')

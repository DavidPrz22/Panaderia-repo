...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recetas_como_componente', to='inventario.productoselaborados'),
        ),
        migrations.AddField(
            model_name='recetas',
            name='producto_elaborado',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recetas_como_producto_final', to='inventario.productoselaborados'),
        ),
        migrations.AddField(
            model_name='recetas',
            name='unidad_medida',

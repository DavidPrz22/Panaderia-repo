...
import type { TLoteMateriaPrimaSchema } from "@/lib/schemas";

export const LotesInputForm = ({typeInput, name, register, placeholder=''}: {
    typeInput: string,
    ...
    if (typeInput === 'textarea') {
        inputElement = <textarea {...register(name)} name={name} placeholder={placeholder} rows={4} 
        ...
        inputElement = <input type={typeInput} {...register(name)} name={name} placeholder={placeholder} 

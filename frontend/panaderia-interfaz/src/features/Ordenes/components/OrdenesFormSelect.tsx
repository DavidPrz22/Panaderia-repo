...
export const OrdenesFormSelect = ({id, value, onChange, children, placeholder}: {id: string, value:  string, onChange: (value: string) => void, children: React.ReactNode, placeholder?: string}) => {
  return (
    <>
                <Select
                  value={value}

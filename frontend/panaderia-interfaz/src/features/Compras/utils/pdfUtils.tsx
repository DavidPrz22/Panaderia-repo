 ...
 */
export const getPDFAsBase64 = async (ordenCompra: OrdenCompra): Promise<TFileBase64> => {
    ...
    const base64 = await HadleFileConversion(new File([blob], `orden-compra-${ordenCompra.id}.pdf`, { type: "application/pdf" }));

    if (!base64) {
        throw new Error("Error al convertir el PDF a base64. Por favor, intenta nuevamente.");
    }

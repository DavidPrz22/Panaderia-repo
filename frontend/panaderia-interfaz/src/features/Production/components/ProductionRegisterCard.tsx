                ...
                <div className="flex flex-1 flex-col gap-2">
                    <div className="font-semibold font-[Roboto]">Cantidad a Producir</div>
                        <div className="flex gap-2">
                            <div className="w-full">
                                <input 
                                type="number" 
                                className="px-2 py-2 w-full outline-none border border-gray-300 rounded-md focus:ring-4 focus:ring-blue-100 focus:border-blue-300 transition-all duration-300"
                                min={0}
                                step={0.1}
                    ...
                    <div className="flex flex-1 flex-col gap-2">
                        ...
                        <div className="flex gap-2 relative">
                            <div className="w-full">
                                <input type="date" className="px-2 py-2 w-full outline-none border border-gray-300 rounded-md focus:ring-4 focus:ring-blue-100 focus:border-blue-300 transition-all duration-300"
                                />
                            </div>
                        </div>
                    </div>

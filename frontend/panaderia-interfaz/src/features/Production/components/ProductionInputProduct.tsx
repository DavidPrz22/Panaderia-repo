    ...
    <div className="flex flex-1 flex-col gap-2 w-full">
                        ...
                        <div className="flex gap-2 relative">
                            ...
                            <div className="w-full">
                                <input type="text" className="pl-11 pr-2 py-2 w-full outline-none border border-gray-300 rounded-md focus:ring-4 focus:ring-blue-100 focus:border-blue-300 transition-[box-shadow] duration-300"

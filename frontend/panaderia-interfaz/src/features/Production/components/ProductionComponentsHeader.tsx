...
export const ProductionComponentsHeader = () => {
    ...
    return (
        <div className="flex items-center justify-between mb-4">
            ...
            <button className=" border border-gray-200 rounded-md p-2 hover:bg-blue-500 hover:text-white hover:border-transparent cursor-pointer transition-colors duration-100 " onClick={handleClick}>

...
export const ProductionCantidad = ({ setValue, watch }: watchSetvalueTypeProduction) => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (setValue) setValue("cantidadProduction", value, { shouldValidate: true, shouldDirty: true });
    }

    const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        const controls = ["Backspace","Tab","ArrowLeft","ArrowRight","Home","End"];

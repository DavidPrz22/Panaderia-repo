...
export const DashBoardHeader = () => {
    ...
    const { isFetching: isNotificationFetching, isFetched: isNotificationFetched } = useDBNotification();
        ...
        <div className='flex justify-between items-center '>
            ...
            {(showNotificaciones && isNotificationFetched) ? (
                ...
                size="lg" variant={"outline"} className='cursor-pointer  font-semibold hover:bg-blue-500 hover:text-white tracking-wide hover:border-transparent'>
                    ...
                    ) : dashboardData?.notificaciones && Number(dashboardData.notificaciones) > 0 ? 
                    <>
